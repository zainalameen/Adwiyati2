...
final treatmentsListProvider =
    FutureProvider.family<List<TreatmentWithMedication>, TreatmentStatus>((
      ref,
      status,
    ) async {
...
final treatmentDetailProvider =
    FutureProvider.family<TreatmentWithMedication?, String>((
      ref,
      treatmentId,
    ) async {
      final user = SupabaseService.auth.currentUser;
...
final treatmentRemindersProvider =
    FutureProvider.family<List<DoseReminderModel>, String>((
      ref,
      treatmentId,
    ) async {
